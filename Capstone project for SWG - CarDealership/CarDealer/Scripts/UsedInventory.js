$('#usedSearchButton').click(function (event) {
    $('#usedSearchResults').empty();
    $.ajax({
        type: 'POST',
        url: 'http://localhost:51045/used',
        data: JSON.stringify({
            Term: $('#UsedSearchTerm').val(),
            MinPrice: $('#UsedSearchMinPrice').val(),
            MaxPrice: $('#UsedSearchMaxPrice').val(),
            MinYear: $('#UsedSearchMinYear').val(),
            MaxYear: $('#UsedSearchMaxYear').val(),
        }),
        headers: {
